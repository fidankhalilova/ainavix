    ...
    <div className="min-h-screen bg-[#F8F9FF] pt-24 pb-16 px-4 flex items-center justify-center">
      <div className="max-w-md w-full text-center">
        <div className="bg-white rounded-3xl border border-[#E8EAFF] shadow-[0_8px_40px_rgba(27,20,100,0.08)] px-8 py-12">
          <div className="w-20 h-20 rounded-full bg-linear-to-br from-[#2E4BC6] to-[#00C2CB] flex items-center justify-center mx-auto mb-6 shadow-[0_0_32px_rgba(0,194,203,0.4)]">
          ...
          <Link
            href="/tools"
            className="inline-flex items-center gap-2 bg-linear-to-r from-[#2E4BC6] to-[#00C2CB] text-white font-bold px-8 py-3.5 rounded-xl shadow-[0_0_20px_rgba(46,75,198,0.3)] hover:shadow-[0_0_30px_rgba(0,194,203,0.4)] transition-all"
          >
