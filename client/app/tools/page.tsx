            ...
            {Array.from({ length: Math.min(totalPages, 7) }).map((_, i) => {
              ...
              return (
                <button
                  ...
                  className={`w-9 h-9 rounded-lg text-sm font-semibold transition-all ${p === page ? "bg-linear-to-r from-[#2E4BC6] to-[#00C2CB] text-white shadow-[0_0_16px_rgba(46,75,198,.3)]" : "border border-[#E8EAFF] text-[#1B1464]/60 hover:border-[#2E4BC6] hover:text-[#2E4BC6]"}`}
                >
                  {p}
                </button>
              );
